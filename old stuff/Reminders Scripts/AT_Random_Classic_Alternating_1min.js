// AT Reminders - Alternates random AT prompt / classic long prompt every 1 min
...
QuickLook.present("Done! " + totalCount + " reminders for today (every 1 min, alternating random AT / classic).");
