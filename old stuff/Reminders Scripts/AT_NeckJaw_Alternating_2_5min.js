// AT Reminders - Alternates "Let your neck be free" / "Let your jaw be free" every 2.5 min
...
let totalCount = 0;
let promptIndex = 0; // carries across days so alternation stays consistent
...
for (let dayOffset = 0; dayOffset < daysToGenerate; dayOffset++) {
  ...
  for (let m = 7 * 60; m < 21 * 60; m += 2.5) {
    ...
    r.title = prompts[promptIndex % prompts.length];
...
QuickLook.present("Done! " + totalCount + " reminders (today–Sunday, every 2.5 min, alternating neck / jaw).");
